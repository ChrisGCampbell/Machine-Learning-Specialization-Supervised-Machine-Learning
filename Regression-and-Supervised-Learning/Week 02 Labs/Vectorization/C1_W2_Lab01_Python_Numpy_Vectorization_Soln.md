...
```
    ...
    np.zeros(4,) :  a = [0. 0. 0. 0.], a shape = (4,), a data type = float64
    np.random.random_sample(4): a = [0.48836252 0.75586795 0.81628718 0.35089997], a shape = (4,), a data type = float64
...
```
    ...
    np.random.rand(4): a = [0.81198934 0.50434449 0.65519804 0.13498676], a shape = (4,), a data type = float64
